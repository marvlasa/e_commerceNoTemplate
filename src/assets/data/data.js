[
{
    ...
    "description": "TV & Monitor Smart LED con conexión a internet, con un nivel por encima de la media, la mejor opcion en relación calidad y precio.",
    ...
    "description": "Magnifica heladera con 2 Puertas con temperatura independiente. Capacidad 450 lts.",
...
},
{
    ...
    "description": "Lavasecarropas automatico LG capacidad 22kg de carga frontal, secado 13kg. Control mediante smartphone.",
...
},
{
    ...
    "description": "Déjate llevar por un audio de alta resolución más natural con los altavoces Magnetic Fluid.",
...
},
{
    ...
    "description": "CPU x86-64-AMD Ryzen “Zen 2” con 8 núcelos y 16 subprocesos, y una frecuencia variable de hasta 3,5 GHz. GPU con 10,3 TFLOPS de potencia, con 36 CUs a una frecuencia variable de hasta 2,23 GHz, basada en AMD Radeon RDNA 2. 16 GB de memoria GDDR6.",
...
},
{
    ...
    "description": "CPU Procesador de 8 núcleos a 3,8 GHz personalizado con microarquitectura AMD Zen 2 y fotolitografía de 7 nm, GPU Procesador gráfico personalizado con 52 unidades de cálculo a 1,825 GHz, microarquitectura AMD RDNA 2 y 12 TFLOPS, MEMORIA 16 GB GDDR6 con bus de 320 bits",
...
},
{
    ...
    "brand": "Apple",
    "name": "Iphone 12 Pro",
    "description": "Estos equipos no incluyen cargador ni auriculares en su caja original, únicamente cable de carga tipo usb-c.",
...
},
{
    ...
    "description": "El Samsung Galaxy S21 Ultra es el más ambicioso de los modelos 'S' de Samsung, que han repetido variantes con el modelo Galaxy S21 estándar y su variante Galaxy S21+",
...
},
{
    ...
    "description": "Cuchillas de acero de alta precisión, uso en seco y húmedo, 3 cabezales flexible en 3 direcciónes, se adaptan a cada curva de tu cara",
...
},
{
    ...
    "description": "Planchita Gama X-Wide Digital Keration 230º Tourmaline Micro Glitt",
